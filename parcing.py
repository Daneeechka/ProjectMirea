...
if __name__ == '__main__':
    ...
    # Loading YOLO scales from files and setting up the network    net = cv2.dnn.readNetFromDarknet("D:\Makarevskiy Igor\Resources\yolov4-tiny.cfg",
    net = cv2.dnn.readNetFromDarknet ("D: \Makarevskiy Igor\Resources\yolov4-tiny.weights")
